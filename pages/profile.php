...
<form name=\"profile\" id=\"profile\" type=\"get\" action=\"pages/profile.php\" onsubmit=\"javascript:sendPost('pages/profile.php?password='+document.profile.password.value+'&firstname='+document.profile.fname.value+'&lastname='+document.profile.lname.value+'&email='+document.profile.email.value);return false;\"><table>
